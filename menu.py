...
def sysop1():
  while True:
      ...
      result=pyfiglet.figlet_format("System Operations", font="bubble")
      print(result)
      print("""
...
def docker1():
  while True:
      os.system("tput setaf 2")
      result=pyfiglet.figlet_format("Docker", font="bubble")
      print(result)
      print("""
...
def lvm():
  while True:
      os.system("tput setaf 2")
      result=pyfiglet.figlet_format("Logical volume Management", font="bubble")
      print(result)
      print("""
...
def aws():
  while True:
      os.system("tput setaf 2")
      result=pyfiglet.figlet_format("Amazon Web Services", font="bubble")
      print(result)
      print("""
      AWS Menu:
      ----------
      ...
      """)
      as1 = int(input("Enter your choice:\t"))
      os.system("tput setaf 15")
...
def webserver():
  while True:
      os.system("tput setaf 2")
      result=pyfiglet.figlet_format("Webserver", font="bubble")
      print(result)
      print("""
      Webserver Menu:
      ----------------
...
def hadoop():
  while True:
    os.system("clear")
    os.system("tput setaf 2")
    result=pyfiglet.figlet_format("Hadoop", font="bubble")
    print(result)
    print("""
    1. Installing Hadoop.
...
def ans():
  while True:
      os.system("tput setaf 2")
      result=pyfiglet.figlet_format("Ansible", font="bubble")
      print(result)
      print("""
      Ansible Menu:
      ----------
...
def nfs():
  while True:
      os.system("tput setaf 2")
      result=pyfiglet.figlet_format("NFS", font="bubble")
      print(result)
      print("""
      \n
      Network File System:
      ...
      """)
      nfs = int(input("Enter your choice:\t"))
      os.system("tput setaf 15")
...
while True:
      ...
      print("\t\t\t--------------------------------------")
      result=pyfiglet.figlet_format("Automation Menu", font="bubble")
      print(result)
      ...
      while True:
            if choice == 1:
                print("""
                \n
                press 1: for running system operations in local system
                press 2 : For running system operations in remote system""")
                ...
                print("""
                \n
                press 1: for running docker in local system
